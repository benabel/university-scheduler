...
export function renderAll(data) {
	...
	// Get containers from state
	const _viewPanels = state.get("viewPanels");
	...
	// Update custom timelines in state
...
export function findHeaderButton(label, header) {
	const h = header || state.get("header");
	if (!h) return null;
