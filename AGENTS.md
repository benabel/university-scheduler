...
This project is indexed by GitNexus as **university-scheduler** (987 symbols, 1919 relationships, 84 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/university-scheduler/context` | Codebase overview, check index freshness |
| `gitnexus://repo/university-scheduler/clusters` | All functional areas |
| `gitnexus://repo/university-scheduler/processes` | All execution flows |
| `gitnexus://repo/university-scheduler/process/{name}` | Step-by-step execution trace |
